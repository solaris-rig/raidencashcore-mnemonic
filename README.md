# raidencashcore-mnemonic

[![Build Status](https://img.shields.io/travis/solaris-rig/raidencashcore-mnemonic/master.svg)](https://travis-ci.org/solaris-rig/raidencashcore-mnemonic)
[![NPM Package](https://img.shields.io/npm/v/raidencashcore-mnemonic.svg)](https://www.npmjs.org/package/raidencashcore-mnemonic)

> BIP39 Mnemonics for RaidenCashCore

A module for [raidencashcore-lib](https://github.com/solaris-rig/raidencashcore-lib) that implements [Mnemonic code for generating deterministic keys](https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki).

## Install

```sh
npm install raidencashcore-mnemonic
```
...
```javascript
var Mnemonic = require('raidencashcore-mnemonic');
...
This will generate a file `dist/raidencashcore-mnemonic.js`, which can be included into your HTML a-like so:

```html
<html lang="en">
<head>
  <title>Tester - RaidenCashCore Mnemonic</title>
  <script language="javascript" src="dist/raidencashcore-mnemonic.js"></script>
</head>
<body>
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      var mnemonic = new raidencashcoreMnemonic();
...
Feel free to dive in! [Open an issue](https://github.com/solaris-rig/raidencashcore-mnemonic/issues/new) or submit PRs.
...
Copyright 2015-2018 MatixPay Core Group, Inc.  
